...
public class SettingsController : ControllerBase
{
    ...
    [HttpGet("layouts")]
    public async Task<ActionResult<List<SavedLayout>>> GetLayouts() => await _settings.GetLayoutsAsync();
    ...
    {
        return Ok(new { Platform = "ASP.NET Core 9.0", Environment = _configuration["ASPNETCORE_ENVIRONMENT"] ?? "Production", MemoryUsage = $"{GC.GetTotalMemory(false) / 1024 / 1024} MB", Version = "1.0.0", Database = "SQLite" });
    }
}
